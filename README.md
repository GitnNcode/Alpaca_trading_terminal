...
<img width="1512" height="949" alt="screenshot" src="https://github.com/user-attachments/assets/485c5f17-056e-469f-857d-b640ad03bb9a" />
...
The canonical Go build lives in `main-trading-terminal-go/`. Sibling folders hold architectural ports (see `CLAUDE.md` for the full list).

```
main-trading-terminal-go/
...
├── chart.go       # Chart canvas + indicator overlays
├── braille.go     # Sub-pixel Braille line drawing
...
```bash
git clone <repo-url>
cd Alpaca_trading_terminal/main-trading-terminal-go
